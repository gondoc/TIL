...
public class Exam02 {
	...
	@Test
	public void test() {
		assertEquals(new Exam02().solution(new int[] {1, 3, 4, 5, 8, 2, 1, 4, 5, 9, 5},"right"), "LRLLLRLLRRL");
		assertEquals(new Exam02().solution(new int[] {7, 0, 8, 2, 8, 3, 1, 5, 7, 6, 2},"left"), "LRLLRRLLLRR");
		assertEquals(new Exam02().solution(new int[] {1, 2, 3, 4, 5, 6, 7, 8, 9, 0},"right"), "LLRLLRLLRL");
	}
}
