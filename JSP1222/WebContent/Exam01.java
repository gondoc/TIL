...
public class Exam01 {
	...
	@Test
	public void test() {
		assertEquals(new Exam01().solution("one4seveneight"), 1478);
		assertEquals(new Exam01().solution("23four5six7"), 234567);
		assertEquals(new Exam01().solution("2three45sixseven"), 234567);
	}
}
