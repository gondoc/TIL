	...
	<form action="updateOk.jsp" enctype="multipart/form-data" method="post" onsubmit="return formCheck();">
		...
		<table>
			<tr>
				...
				<td colspan="4" class="title">자료실 새 글 작성하기</td>
			</tr>
			<tr>
				<td class="item">이름</td>
				<td>
			...
			<tr>
				...
				<td colspan="3">
					<div style="margin-bottom: 5px;">
						<input type="button" value="+" class="btn btn-outline-success" onclick="appendFile()">
						<input type="button" value=" - " class="btn btn-outline-success" onclick="removeFile()">
					</div>
					<div id="fileBox">
