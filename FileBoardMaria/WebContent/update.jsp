	...
	<form action="updateOk.jsp" enctype="multipart/form-data" method="post" onsubmit="return formCheck();">
		...
		<table>
			<tr>
				...
				<td colspan="4" class="title">자료실 글 수정하기</td>
			</tr>
			<tr>
				<td class="item">이름</td>
				<td>
			...
			<tr>
				...
				<td colspan="3">
					...
					<div style="margin-bottom: 5px;">
						<input type="button" value=" + " class="btn btn-outline-success btn-sm" onclick="appendFile()">
						<input type="button" value=" - " class="btn btn-outline-success btn-sm" onclick="removeFile()">
					</div>
					<div id="fileBox">
			...
			<tr>
				<td colspan="4" style="border:none; text-align:right;">
					...
					onclick='sendPost("view.jsp", {"p":${p},"s":${s},"b":${b},"idx":${vo.idx}})' value="이전"/>
					<input type="button" class="btn btn-outline-success" 
