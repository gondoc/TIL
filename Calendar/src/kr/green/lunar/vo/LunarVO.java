...
public class LunarVO {
	...
	public String getSolarMonth(){
		return solar.split("-")[1]; // -로 구분하여 배열을 만들고 첫번째 값은 연도다.
	}
	// 3. 일
	public String getSolarDate(){
		return solar.split("-")[2].split(" ")[0]; // -로 구분하여 세번째 다시 공백으로 구분하여 첫번째 값.
	}
	// 4. 요일(숫자)
...
public String getSolarWeek(){
	...
	public String getLunarMonth(){
		return lunar.split("-")[1]; // -로 구분하여 배열을 만들고 첫번째 값은 연도다.
	}
	// 3. 일
	public String getLunarDate(){
		return lunar.split("-")[2].split(" ")[0]; // -로 구분하여 세번째 다시 공백으로 구분하여 첫번째 값.
	}
	// 4. 요일(숫자)
	public int getLunarIntWeek(){
		String week = "일월화수목금토";
		return week.indexOf(solar.split("-")[2].split(" ")[1].charAt(1));
	}
	// 5. 요일(문자)
	public String getLunarWeek(){
		return solar.split("-")[2].split(" ")[1].charAt(1)+""; 
	}
	...
	// 2. 월건을 구해보자 
	public String getGanjiMonthK() { // 월건을 한글로
	...
	public String getGanjiMonthH() { // 월건을 한자로
		if(ganji.split(" ").length==3) { // 년월이 모두 있는 경우
